  ...
  return (
    <Router>
      <div className="bg-white shadow p-4 flex gap-4">
        <Link to="/" className="text-indigo-600 hover:underline">Accueil</Link>
...
import HomePage from './pages/HomePage'; // Vérifie que ce fichier existe
import LoginPage from './pages/LoginPage'; // Vérifie que ce fichier existe
import Dashboard from './pages/Dashboard'; // Vérifie que ce fichier existe
import PrivateRoute from './components/PrivateRoute'; // Vérifie que ce fichier existe

export default function App() {
  const { token } = useContext(AuthContext); // Vérifie que le contexte fonctionne
...
<label htmlFor="file-upload" className="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 focus-within:outline-hidden hover:text-indigo-500">
  ...
  <input id="file-upload" name="file-upload" type="file" className="sr-only" aria-label="Upload a file" />
</label>
...
export default function Example() {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      {/* Correct Menu.Items usage */}
      <Menu.Items
        transition
        className="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black/5 transition focus:outline-hidden"
      >
        <div className="py-1">
          <MenuItem>
            <a
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
               ...
               Welcome netmanagement friend
    
          
              to a great journey into the cleverest system to control with Artificial intelligence the Market of Crypto
              Control with Xero, AUTHO, Okta, Saferpay, Gocardless, Chatgpt4, and Solaris  the System of banking
